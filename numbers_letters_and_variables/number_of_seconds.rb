...
puts "There are #{hours_per_day} hours in a day" # should be a day, bad grammar
...
puts "That means when you turn 20, you've been alive for #{(seconds_per_year *
  20).to_i} seconds,"
puts "and if you make it to 100, you will have lived #{(seconds_per_year *
  100).to_i} seconds. Make them count!"
